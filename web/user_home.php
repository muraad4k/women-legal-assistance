    ...
    <div class="offcanvas offcanvas-start suha-offcanvas-wrap" tabindex="-1" id="suhaOffcanvas" aria-labelledby="suhaOffcanvasLabel">
      ...
      <div class="offcanvas-body">
        ...
        <ul class="sidenav-nav ps-0">
          ...
          <li><a href="user_home.html"><i class="lni lni-home
"></i>Home</a></li>
            ...
            <div class="col-12 col-md-12">
              <div class="card horizontal-product-card">
                <div class="card-body d-flex align-items-center">
                  <div class="card-body"><img class="img-fluid" style="width:64px; height:64px;"  src="img/advocate.png"/>&nbsp;&nbsp;&nbsp;<a class="text-success" href="view_business.html">
                    Search Advocate</a></div>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-12">
