...
/****************************************************************************/
	...
	{			// 'field_1':$scope.field_1,
			// 'field_8':$scope.field_8,	
		$http.post('create_business.php', {
			'field_name':$scope.x.name,
	...
	{				
		...
		$http.post('create_problem.php', {
		'field_2':$scope.field_2,'field_3':$scope.field_3,
		'field_4':$scope.field_4,'field_5':$scope.field_5,'field_6':$scope.field_6,'field_7':$scope.field_7,
...
/****************************************************************************/
	...
	$http.post('get_all_problem.php')
	.success(function(data, status, headers, config) 
	{
			$scope.user_problem_details = data.details;
    });
	$http.post('getProblems.php')
	.success(function(data, status, headers, config) 
	{
			$scope.user_problem_detail = data.details;
    });
...
/****************************************************************************/
	...
	{		
		...
		{
		'field_1':$scope.field_1,'field_2':$scope.field_2,'field_3':$scope.rating,'email':$scope.cook_field_1,
		})
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
...
$scope.user_update_info = function(name,password,mobile,address) 
	{
		...
		$cookieStore.put("cook_address",address);
		return;
	}	
	...
	$scope.cook_address = $cookieStore.get("cook_address");
